...
class Transaction {
	 ...
	 * instances are created by the query factory's
	 * [newTransaction]{@link module:x2node-queries~QueryFactory#newTransaction}
	 * method.</b>
	 *
	 ...
	 * success.
	 * @returns {external:Promise} Promise that is resolved with the
