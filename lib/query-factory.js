...
class QueryFactory {
	 ...
	 * [createQueryFactory]{@link module:x2node-query.createQueryFactory}
	 * function.</b>
	 *
	 * @param {module:x2node-query.DBDriver} dbDriver Database driver to use.
	 */
	 ...
	 * returned.
	 * @returns {module:x2node-query~Query} The query object.
	...
	build(recordTypes, topRecordTypeName, querySpec) {
		...
		return new Query(
			this._dbDriver, recordTypes, topRecordTypeName, querySpec);
	}
};
