...
class RecordsFilter extends Translatable {
	 ...
	 * filter are modified.
	 *
	 * @param {module:x2node-queries~RecordsFilter} otherFilter The other filter.
	 * @returns {module:x2node-queries~RecordsFilter} Resulting conjunction.
	 */
	conjoin(otherFilter) {
 ...
 * @memberof module:x2node-queries
 * @inner
 * @extends module:x2node-queries~RecordsFilter
 */
class RecordsFilterJunction extends RecordsFilter {
	 ...
	 *
	 * @param {module:x2node-queries~RecordsFilter} element Element to add to the
	 * junction. If the element is empty, it's ignored.
	 * @returns {module:x2node-queries~RecordsFilterJunction} This junction.
	 */
	addElement(element) {
 ...
 * @returns {module:x2node-queries~RecordsFilter} The filter. May return
