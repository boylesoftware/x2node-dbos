...
class UpdateDBO extends AbstractDBO {
	...
	constructor(dbDriver, recordTypes, recordTypeDesc, patch, filterSpec) {
		...
		// parse the patch
		this._patch = patches.build(recordTypes, recordTypeDesc.name, patch);
	 ...
	 * @property {number} recordsUpdated Number of records affected by the
	 * operation, including zero if none.
