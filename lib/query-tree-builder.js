...
class QueryTreeNode {
	 ...
	 * @param {Map.<string,module:x2node-queries~RecordsFilter>} delayedJoinConditions
	 ...
	 *
	 * @returns {module:x2node-queries~QueryTreeNode} The new top node.
	 */
	behead() {
	 ...
	 * used for the join.
	 * @param {module:x2node-queries~RecordsFilter} [joinCondition] Optional
	 * additional condition for the join. If provided, the node is made virtual
	 * regardless of the <code>virtual</code> flag.
	 * @param {module:x2node-queries~RecordsOrder} [order] Optional additional
	 ...
	 * @param {module:x2node-queries~RecordsFilter} [colFilter] Optional
	 ...
	 *
	 * @private
	 * @param {module:x2node-queries~PropertyTreeNode} propNode Scalar simple
	 * value property node.
	 ...
	 * @returns {module:x2node-queries~QueryTreeNode} The leaf node possibly
	 ...
	 *
	 * @private
	 * @param {module:x2node-queries~PropertyTreeNode} propNode Reference
	 ...
	 * @param {boolean} fetchedRef <code>true</code> if fetched reference.
	 * @returns {module:x2node-queries~QueryTreeNode} The leaf node added by the
	 * method.
	 */
	 ...
	 *
	 * @param {module:x2node-queries~RecordsFilter} [filter] Filter to generate
	 * the WHERE clause.
	 * @param {module:x2node-queries~RecordsOrder} [order] Order to generate the
	 * ORDER BY clause.
	 * @param {module:x2node-queries~FilterParamsHandler} paramsHandler DBO
	 * parameters handler.
	 ...
	 * @returns {module:x2node-queries~QueryTreeNode} The attachment node.
	 */
	 ...
	 * its parent, if any.
	 *
	 * @type {module:x2node-queries~RecordsFilter}
	 * @readonly
	 */
 ...
 * tree.
 * @param {module:x2node-queries~QueryTreeNode} [anchorNode] Anchor table node,
 * if any.
 ...
 * @param {module:x2node-records~RecordTypesLibrary} recordTypes Record types
 * library.
 * @param {module:x2node-queries~PropertyTreeNode} superPropsTree Selected
