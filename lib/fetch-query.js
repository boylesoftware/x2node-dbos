...
class FilterParamsHandler {
	 ...
	 * provided with query call returns the ES literal for the value to include
	 * in the query.
	 * @returns {string} Parameter placeholder to include in the query in the
	 ...
	 * @param {*} paramValue Parameter value from the query specification.
	 ...
	 * @returns {string} Parameter value SQL expression to include in the query.
	 */
	 ...
	 *
	 * @param {module:x2node-queries.DBDriver} dbDriver DB driver.
	 * @param {Object.<string,*>} filterParams Parameters provided with the query
	 * call.
	 * @param {string} paramRef Parameter reference from the query.
	 * @returns {string} Parameter value SQL expression to include in the query.
	 */
...
class FetchQuery {
	 ...
	 * @returns {Promise.<Object>} The result promise. The result object has
	 * <code>records</code> and optionally <code>referredRecords</code>
