...
/**
 * Single query order element. The full order is an array of these.
 *
 * @private
 ...
 * @returns {module:x2node-queries~QueryOrder[]} Parsed order specification
 ...
 */
exports.buildOrder = function(valueExprCtx, orderSpecs, usedPropPaths) {
