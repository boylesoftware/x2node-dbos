...
class RecordsOrder extends Translatable {
	 ...
	 *
	 * @param {module:x2node-queries~RecordsOrderElement} element Element to add.
	 * @returns {module:x2node-queries~RecordsOrder} This order specification.
	 */
	addElement(element) {
	 ...
	 * Order elements.
	 *
	 * @type {module:x2node-queries~RecordsOrderElement[]}
	 * @readonly
	 */
 ...
 * @returns {module:x2node-queries~RecordsOrder} Parsed order specification, or
